...
//     const HOURS_PER_DAY = 9; // Define daily work hour requirement
//     const TEST_TEAM_LEAD_EMAIL = 'lokesh.kumar@sportsdunia.com';

//     logger.info(`Starting weekly report generation for all teams: ${formatDateYMD(startDate)} to ${formatDateYMD(endDate)}`);

//     try {
//         // FETCH ALL USERS AND GROUP THEM BY TEAM LEAD
...
//             // if (lead.email !== TEST_TEAM_LEAD_EMAIL) continue;
